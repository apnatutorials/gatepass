...
@Component({
  selector: 'app-vahan-pravesh-patr-sachivalaya-vishesh-sachiv',
  templateUrl: './vahan-pravesh-patr-sachivalaya-vishesh-sachiv.component.html',
  styleUrls: ['./vahan-pravesh-patr-sachivalaya-vishesh-sachiv.component.css']
})
export class VahanPraveshPatrSachivalayaVisheshSachivComponent implements OnInit {

 
  private vahanPassBFormGroup: FormGroup = null;
  ...
  ngOnInit() {
    this.vahanPassBFormGroup = new FormGroup ({
  ...
  private onSubmit(){
    ...
    console.log(this.vahanPassBFormGroup);
    if(this.vahanPassBFormGroup.valid){
     // code if the form is valid 
     console.log(this.vahanPassBFormGroup)
    }
    else{
      // code in else , the form is invalid
      Object.keys(this.vahanPassBFormGroup.controls).forEach(field =>{
        const control = this.vahanPassBFormGroup.get(field);
