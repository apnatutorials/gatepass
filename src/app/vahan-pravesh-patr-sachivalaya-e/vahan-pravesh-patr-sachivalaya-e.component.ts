...
@Component({
  selector: 'app-vahan-pravesh-patr-sachivalaya-e',
  templateUrl: './vahan-pravesh-patr-sachivalaya-e.component.html',
  styleUrls: ['./vahan-pravesh-patr-sachivalaya-e.component.css']
})
export class VahanPraveshPatrSachivalayaEComponent implements OnInit {
