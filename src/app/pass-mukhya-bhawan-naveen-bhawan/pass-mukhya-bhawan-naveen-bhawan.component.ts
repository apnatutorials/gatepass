...
@Component({
  selector: 'app-pass-mukhya-bhawan-naveen-bhawan',
  templateUrl: './pass-mukhya-bhawan-naveen-bhawan.component.html',
  styleUrls: ['./pass-mukhya-bhawan-naveen-bhawan.component.css']
})
export class PassMukhyaBhawanNaveenBhawanComponent implements OnInit {

  private NaveenBhawanFormGroup: FormGroup = null;
  ...
  ngOnInit() {
    this.NaveenBhawanFormGroup = new FormGroup ({
  ...
  private onSubmit(){
    ...
    console.log(this.NaveenBhawanFormGroup);
    if(this.NaveenBhawanFormGroup.valid){
     // code if the form is valid 
     console.log(this.NaveenBhawanFormGroup)
    }
    else{
      // code in else , the form is invalid
      Object.keys(this.NaveenBhawanFormGroup.controls).forEach(field =>{
        const control = this.NaveenBhawanFormGroup.get(field);
